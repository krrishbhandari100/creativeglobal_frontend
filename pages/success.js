...
const Success = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:1337/api/orders/${router.query.orderId}`, {
            method: "POST",
            headers: {
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-20">
                    ...
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Congratulations, you have successfully placed your order</p>
                </div>
