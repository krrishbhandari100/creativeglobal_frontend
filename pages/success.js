        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base font-bold text-green-400">Congratulations, you have successfully placed your order!</p>
                </div>
                ...
                <div className="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                    ...
                    <Link href="/">
                        <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Go Home</button>
                    </Link>
                </div>
            </div>
        </section>
