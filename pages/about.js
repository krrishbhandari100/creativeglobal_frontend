        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="text-center mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Be Friendly with us</h1>
                    <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
                        A manufacturing company involved in manufacturing of various kind of wooden & wrought iron handicraft furniture. The company has in - house production for most of the wooden & iron products. The company has its own kilns for seasoning & pressurized chemical chambers for treating wood.
                    </p>
