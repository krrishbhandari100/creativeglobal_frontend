            ...
            <div className="container px-2.5 py-12 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    ...
                    {Object.keys(products).map((item) => {
                        return (
                            <>
                                <div className="lg:w-1/3 sm:w-1/2 p-4 shadow-md ml-3 mt-4">
                                    <div className="flex relative h-[300px]">
                                        <img alt="gallery" className="absolute inset-0 w-full h-full object-center" src={`http://localhost:1337${products[item].attributes.image.data.attributes.formats.thumbnail.url}`} />
                                            ...
                                            <div>
                                                ...
                                                <div className='flex mb-4 justify-between w-[103px]'>
                                                    {products[item].color.map((color)=>{
                                                        return (
                                                            <>
                                                            <div className='rounded h-5 w-5' style={{background: `${color}`}}></div>
                                                            </>
                                                        )
                                                    })}
                                                </div>
